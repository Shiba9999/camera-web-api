...
captureImgBtn.addEventListener("click", function () {
    ...
    // scaling
    // top left corner
    //scale level we use to zoom canvas 
    //when we use zoom it only zoom the ui to apply zoom on the canvas we have to use scalelevel simply just stack overflow this

    tool.scale(scaleLevel, scaleLevel);
    //zoom from center oof the canvas
